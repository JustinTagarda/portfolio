  ...
  return (
    <main id="top" className="relative min-h-screen overflow-x-clip bg-[#0B1220] text-[rgba(255,255,255,0.92)]">
      ...
      <div className="relative z-10">
        ...
        <section className="mx-auto grid max-w-7xl items-start gap-6 px-4 pb-6 pt-6 sm:px-5 md:px-8 md:pb-8 md:pt-8 lg:grid-cols-[minmax(0,1fr)_18rem] lg:gap-6 lg:pb-6 lg:pt-10 xl:gap-8">
          <div className="space-y-6 lg:max-w-[52rem]">
            ...
            <div className="flex flex-wrap gap-2.5">
              {data.heroChips.map((chip) => (
                <span
                  key={chip}
                  className="rounded-full border border-[rgba(245,158,11,0.35)] bg-[rgba(245,158,11,0.16)] px-2.5 py-1 text-[11px] font-medium text-[rgba(255,255,255,0.92)] md:px-3 md:py-1.5 md:text-sm"
                >
                  {chip}
                </span>
              ))}
