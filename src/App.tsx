  ...
  projects: [
    {
      ...
      bullets: [
        "Reads selected text from other apps with staged retrieval fallbacks.",
        "Supports manual text, selected-text, and document reading.",
        "Provides global hotkeys, tray actions, and quick stop controls.",
        "Supports downloadable voice models and preferred voice selection.",
        "Includes speech-rate control, themes, and local diagnostics.",
      ],
